...
import sms.oneapi.model.TerminalLocation;
import sms.oneapi.model.TerminalLocation.RequestError;
...
public class LocationResponse implements java.io.Serializable {
	 ...
	 * @see RequestError
	 */
	sms.common.exceptiontype.RequestError requestError=null;
	 ...
	 */
	public sms.common.exceptiontype.RequestError getRequestError() { return requestError; }
