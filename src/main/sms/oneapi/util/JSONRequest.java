...
import sms.common.exceptiontype.RequestErrorWrapper;
import sms.oneapi.model.FormParameter;
...
public class JSONRequest<T> {
	...
	static final Logger logger = LoggerFactory.getLogger(JSONRequest.class);
